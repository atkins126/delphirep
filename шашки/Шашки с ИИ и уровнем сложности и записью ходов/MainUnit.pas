...
var
  ...
  S : String;
begin
  AssignFile(F, 'Сохраненная партия.txt');
  Rewrite(F);
  for I := 0 to PartyView.Items.Count - 1 do
  begin
    S := PartyView.Items.Item[I].Caption + ',';
    for J := 0 to PartyView.Items.Item[I].SubItems.Count - 1 do
      S := S + PartyView.Items.Item[I].SubItems.Strings[J] + ',';
