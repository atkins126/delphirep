...
uses
  ...
  Dialogs, ComCtrls, StdCtrls, ExtCtrls, DBCtrls, Grids, DBGrids,DateUtils,ComObj,Excel2000;
...
//exec report1 '2005-01-01','2010-12-12'{не рвыводит, для проверки}
fdm.Querysl.Close;
...
procedure TFmain.DateTimePicker6Change(Sender: TObject);
begin
//exec report2 '2020-07-11' проверять на этих данных
fdm.Querysl.Close;
fdm.Querysl.SQL.Clear;
fdm.Querysl.SQL.Text:='exec report2 '+QuotedStr(DateToStr_(DateTimePicker6.Date));
fdm.Querysl.ExecSQL;
fdm.Querysl.Open;
fdm.Querysl.Close;
fdm.Querysl.Open;
...
begin
 ...
 begin
   key:=#0;
   ShowMessage('введенн не тот  знак ');
 end;
