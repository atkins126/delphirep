...
ShowMessage('Файл сохранен с именем'+SD1.FileName+'.'+'sql' );
end;
end;
...
ShowMessage('Загружено из файла'+ OD1.FileName);
end;
end;
...
Memo2.SetFocus;
MessageDlg('Исправляем запрос',mtInformation,[mbYes],0  );
end;
end;
