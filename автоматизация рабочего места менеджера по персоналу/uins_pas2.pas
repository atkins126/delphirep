...
procedure TFins_pass.DBLookupComboBox1Click(Sender: TObject);
begin
fdm.del_klient.Parameters.ParamByName('@klient_id').Value:=fdm.Queryklient.FieldByName('klient_id').AsString;
fdm.del_klient.ExecProc;
fdm.Querysl.Close;
fdm.Querysl.Open;
ShowMessage('done');
end;

procedure TFins_pass.DBLookupComboBox2Click(Sender: TObject);
begin
fdm.del_men.Parameters.ParamByName('@maneger_id').Value:=fdm.Querymen.FieldByName('maneger_id').AsString;
fdm.del_men.ExecProc;
fdm.Querysl.Close;
fdm.Querysl.Open;
ShowMessage('done');
end;

procedure TFins_pass.DBLookupComboBox3Click(Sender: TObject);
begin
fdm.del_usluga.Parameters.ParamByName('@id_usl').Value:=fdm.Queryusl.FieldByName('id_usl').AsString;
fdm.del_usluga.ExecProc;
fdm.Querysl.Close;
fdm.Querysl.Open;
ShowMessage('done');
end;

procedure TFins_pass.DBLookupComboBox4Click(Sender: TObject);
begin
fdm.del_pass.Parameters.ParamByName('@user_id').Value:=fdm.Querypas.FieldByName('user_id').AsString;
fdm.del_pass.ExecProc;
fdm.Querysl.Close;
fdm.Querysl.Open;
ShowMessage('done');
end;

procedure TFins_pass.DBLookupComboBox5Click(Sender: TObject);
begin
    fdm.del_mplan.Parameters.ParamByName('@id_plan').Value:=fdm.Queryplan.FieldByName('id_plan').AsString;
    fdm.del_mplan.ExecProc;
    fdm.Querysl.Close;
    fdm.Querysl.Open;
    ShowMessage('done');
end;
...
fdm.Querysl.Close;
fdm.Querysl.SQL.Text:='select  * from mplan';
fdm.Querysl.Open;
end;
...
begin
LabeledEdit13.EditLabel.Caption:='Поиск клиента по имени';
t:=1;
end;
end;
...
begin
LabeledEdit13.EditLabel.Caption:='Поиск менеджера по имени';
t:=2;
end;

procedure TFins_pass.RadioButton3Click(Sender: TObject);
begin
LabeledEdit13.EditLabel.Caption:='Плана  по Названию';
t:=3;
end;

procedure TFins_pass.RadioButton4Click(Sender: TObject);
begin
LabeledEdit13.EditLabel.Caption:='услуги   по описаниюю';
t:=4;
end;

procedure TFins_pass.RadioButton5Click(Sender: TObject);
begin
LabeledEdit13.EditLabel.Caption:='Пароля по Юзерю';
t:=5;
end;
...
fdm.Querysl.Close;
fdm.Querysl.SQL.Text:='select  * from klient';
fdm.Querysl.Open;
end;
...
fdm.Querysl.Close;
fdm.Querysl.SQL.Text:='select  * from manager';
fdm.Querysl.Open;
end;
...
fdm.Querysl.Close;
fdm.Querysl.SQL.Text:='select  * from usluga';
fdm.Querysl.Open;
end;
...
fdm.Querysl.Close;
fdm.Querysl.SQL.Text:='select  * from usver ';
fdm.Querysl.Open;
end;
